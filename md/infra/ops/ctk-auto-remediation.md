...
VMwareの増分[バックアップ](https://fununi222.github.io/website/html/glossary/system-glossary.html#:~:text="バックアップ")に不可欠な機能である [CBT](https://fununi222.github.io/website/html/glossary/system-glossary.html#:~:text="CBT") は、仮想マシンの構成パラメータ（ctkEnabled）と実際の仮想ディスク（scsiX:Y.ctkEnabled）の不整合により、予期せず無効化されることがあります。

不整合が起きると、[バックアップ](https://fununi222.github.io/website/html/glossary/system-glossary.html#:~:text="バックアップ")ソフトはデータの整合性を保つためにフルスキャン（事実上のフルバックアップ）にフォールバックし、[バックアップ](https://fununi222.github.io/website/html/glossary/system-glossary.html#:~:text="バックアップ")時間とストレージ容量を圧迫します。

## 2. 技術スタック：PowerShell × Jenkins

手動での確認を排除するため、[PowerShell](https://fununi222.github.io/website/html/glossary/system-glossary.html#:~:text="PowerShell") (PowerCLI) を使用して全VMの [CBT](https://fununi222.github.io/website/html/glossary/system-glossary.html#:~:text="CBT") ステータスを走査し、不整合を検知した場合に自動的にリセットするフローを構築しました。[Jenkins](https://fununi222.github.io/website/html/glossary/system-glossary.html#:~:text="Jenkins") を用いることで、毎日12:00（バックアップ実行前）の定期実行と通知を一元管理しています。
...
[スナップショット](https://fununi222.github.io/website/html/glossary/system-glossary.html#:~:text="スナップショット")を頻繁に作成・削除するとスタンが発生する可能性があるため、[バックアップ](https://fununi222.github.io/website/html/glossary/system-glossary.html#:~:text="バックアップ")実行直前かつ低負荷な時間帯を選んで実行する必要があります。
