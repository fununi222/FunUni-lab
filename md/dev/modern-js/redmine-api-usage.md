...
Redmine環境によっては、APIキーだけでなく[Basic認証](https://fununi222.github.io/website/html/glossary/system-glossary.html#:~:text="Basic認証")が必要な場合があります。
...
数千件規模のチケットを[生成AI](https://fununi222.github.io/website/html/glossary/system-glossary.html#:~:text="生成AI")（[RAG](https://fununi222.github.io/website/html/glossary/system-glossary.html#:~:text="RAG")）に投入する場合、ブラウザでの検索結果と同じ条件でAPIから取得するのが最も効率的です。
...
抽出したJSONを[生成AI](https://fununi222.github.io/website/html/glossary/system-glossary.html#:~:text="生成AI")に効率よく学習・検索させるためのポイントです。

- **JSONL形式への変換**: ExcelやCSVよりも、1行1チケットのJSONL（JSON Lines）形式が[LLM](https://fununi222.github.io/website/html/glossary/system-glossary.html#:~:text="LLM")のトレーニングやベクトル検索用のチャンク分割に適しています。
