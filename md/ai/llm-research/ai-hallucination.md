...
desc: "検索エンジンと強力に連携し、事実確認や最新情報の検索に強いです。一度に読み込める文章量（<a href='https://fununi222.github.io/website/html/glossary/system-glossary.html' class='text-secondary hover:underline cursor-help'>コンテキストウィンドウ</a>）が圧倒的で、分厚いマニュアルの一括解析に最適です。",
scores: [6, 7, 10, 7, 7]
},
creative: {
