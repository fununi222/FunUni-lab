...
## 1. 手法の比較分析
なぜ公式の [X](https://fununi222.github.io/website/html/glossary/system-glossary.html#:~:text="X") [API](https://fununi222.github.io/website/html/glossary/system-glossary.html#:~:text="API") ではなく「Yahoo!リアルタイム検索」を採用するのかを分析します。以下のレーダーチャートは、個人開発者がエージェントを構築する際の主要な指標に基づいた比較です。
