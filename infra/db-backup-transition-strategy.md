...
### [post-thaw-script](https://fununi222.github.io/website/article.html?md=glossary/system-glossary.md#:~:text="post-thaw-script") エラーの分類
- **事象**: [vSphere](https://fununi222.github.io/website/article.html?md=glossary/system-glossary.md#:~:text="vSphere")連携時にスクリプト実行結果がエラー（1）を返すが、データ自体は整合性が保たれているケース。
...
## 結論：運用まで含めた「完成」の定義
[IaC](https://fununi222.github.io/website/article.html?md=glossary/system-glossary.md#:~:text="IaC")による構築自動化が進む現代においても、エンタープライズ領域の移行では「人間がどう判断し、どう連絡するか」という運用プロセスの設計が最終的な品質を左右します。
