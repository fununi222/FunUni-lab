...
実は**「[カスタムスケーリング](article.html?md=glossary/system-glossary.md#:~:text="カスタムスケーリング")」**という機能を使えば、110%に設定することが可能です。
...
> **💡 注意点**
> [カスタムスケーリング](article.html?md=glossary/system-glossary.md#:~:text="カスタムスケーリング")を使用すると、ごく一部の古いアプリで文字がぼやけたり、レイアウトが少し崩れたりすることがあります。気になった場合はいつでも元の100%や125%に戻せます。
...
* **表示スケールは「[カスタムスケーリング](article.html?md=glossary/system-glossary.md#:~:text="カスタムスケーリング")」で110%に微調整！**
